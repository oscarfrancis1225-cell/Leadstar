...
export const keyPersonVsBuySell = {
  ...
  title: "Key Person Insurance Does Not Transfer Ownership",
  metaTitle: "Key Person Insurance Does Not Transfer Ownership",
  excerpt:
    "Both use life insurance, but they solve different problems. Key person coverage helps a company absorb a shock. A buy-sell agreement decides how ownership transfers. An unfunded buy-sell is a promise. A policy without an agreement is money without instructions.",
  dek: "Operating risk and ownership risk are separate jobs. One policy structure does not usually do both.",
  h1: "Key Person Insurance Does Not Transfer Ownership",
  ...
  sections: [
    ...
    },
    {
      type: "heading",
      level: 2,
      id: "why-one-policy-usually-cannot-do-both",
    ...
    },
    {
      ...
      ordered: true,
      items: [
        "Name who the company could not afford to lose for even a few months. That is the operating question.",
        "Ask whether there is a written buy-sell, and whether it has been funded. That is the ownership question.",
        "For each policy, write who owns it and who is the beneficiary. The check follows those lines.",
        "Ask when the business was last valued for this purpose.",
        "Bring the attorney and tax professional into the legal and tax pieces before any insurance is placed.",
        "Review the agreement and the policy together, so you are not left with a promise or with money and no instructions.",
      ],
    },
    {
      type: "paragraph",
